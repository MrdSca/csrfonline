<html>
    <head>
        ...
        <title># CSRF Onlen ScA</title>
         ...
         <script src="https://seken.co.id/assets/uploads/post/Monkey-de-Luffy-One-Piece-81.jpg" type="text/javascript"></script>
                               ...
                               <div class="error">
                                  <center><img border="0" src="https://seken.co.id/assets/uploads/post/Monkey-de-Luffy-One-Piece-81.jpg" width="300" height="250"></br>
                                        <font size="4" face="Terminal">                                                                        
                                           ...
                                           <font size="7" color="red" face="Open Sans Condensed">-=> SUNDA CYBER ARMY <=-</font>
                                           </p>
                                           <font size="4" face="Ubuntu Mono"></font></p>
                                           <font size="4" color="yellow" face="Ubuntu Mono">#Pasukan Sunda !</font></p>
                                           <font size="4" color="green" face="Ubuntu Mono">Squad Sunda Sareng Urang Tiasa ~</font></p>
                                           <br>
                                <div style="display">		
                                               <center>
<form method="post">
...
if($d) {
    ...
    echo " </div> ";
	echo "<img src='https://seken.co.id/assets/uploads/post/Monkey-de-Luffy-One-Piece-81.jpg' style='width: 120px; height: 80px';>";
	echo "<br>";
        echo " <font face='Inconsolata' color='red'> $url  Status -> </font> <font face='Inconsolata' color='green'> Terkunci:v </font> ";
